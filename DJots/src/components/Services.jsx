                ...
                <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {posts.map((post) => (
                        ...
                        >
                            ...
                            <h3 className="mt-3 text-lg font-semibold leading-6 text-white flex justify-between items-center">
                                <a href={post.href}>
                                    <span className="absolute inset-0" />
                                    {post.title}
                                </a>
                                <Button className="text-lg font-normal leading-6 text-white "> Upload</Button>
                            </h3>
                        </article>
                    ))}
                </div>
